...
**Full Time-parametrized equations:**

1) $
i \omega \tilde{\mathbf{v}} + 2\hat{\mathbf{z}} \times \tilde{\mathbf{v}} = -\nabla \tilde{P} + E_\eta B_r \partial_r \tilde{\mathbf{b}} - \tilde{N}^2 (\tilde{\mathbf{u}} \cdot \hat{\mathbf{r}})\hat{\mathbf{r}} + E\nabla^2 \tilde{\mathbf{v}}
$


2) $
i \omega \tilde{\mathbf{b}} = B_r \partial_r \tilde{\mathbf{v}} + E_\eta \nabla^2 \tilde{\mathbf{b}}
$


3) $
i \omega \tilde{u}_r = \tilde{v}_r
$
